  ...
  return (
    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8">
      ...
      <div className="flex-1 space-y-6">
        ...
        <div className="w-full sm:w-auto flex flex-col sm:flex-row gap-3">
          ...
          className="border rounded-md px-6 py-3 text-[#3730A3] font-Inter font-medium text-lg flex justify-center items-center gap-1 bg-[#FFFFFF] border-[#3730A3] dark:bg-[#383838] dark:border-specialWhite">
            ...
            <img className="w-6 h-6 filter-logo-filter-light dark:filter-logo-filter-dark" src="\public\assets\github-mark.svg" />
          ...
          flex justify-center items-center gap-1 bg-[#FFFFFF] border-[#3730A3] dark:bg-[#383838] dark:border-specialWhite">
            ...
            <img className="w-6 h-6 filter-logo-filter-light dark:filter-logo-filter-dark " src="\public\assets\LI-In-Bug.svg"alt="LinkedIn"/>
      ...
      <div className="flex-1">
        <img src="public\assets\foto.jpg" className="w-full sm:w-auto max-w-md rounded-3xl" /> 
      </div>
